...
export declare type MATHITEM = MathItem<any, any, any>;
...
export declare type TypesetCall = (document: MATHDOCUMENT) => void;
export declare type ConvertCall = (math: MATHITEM, document: MATHDOCUMENT) => void;
...
export declare namespace Startup {
    ...
    function toMML(node: MmlNode): any;
    ...
    function extendHandler(extend: HandlerExtension): void;
    function typesetCall(fn: string | TypesetCall, priority: number): void;
    function clearTypesetCalls(): void;
    function convertCall(fn: string | ConvertCall, priority: number): void;
    function clearConvertCalls(): void;
    ...
    function convertMath(mitem: MATHITEM, document: MATHDOCUMENT, maxPriority?: number): any;
    function getInputJax(): InputJax<any, any, any>[];
    function getOutputJax(): OutputJax<any, any, any>;
    function getAdaptor(): DOMAdaptor<any, any, any>;
