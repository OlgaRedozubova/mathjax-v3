        ...
        if (!this.processed.findMath) {
            ...
            try {
                for (var _f = __values(this.adaptor.getElements(options['elements'], this.document)), _g = _f.next(); !_g.done; _g = _f.next()) {
                    ...
                    try {
                        for (var _j = __values(this.inputJax), _k = _j.next(); !_k.done; _k = _j.next()) {
                            var jax = _k.value;
                            ...
                            if (jax.processStrings) {
                                ...
                                try {
                                    for (var _l = __values(jax.findMath(strings)), _m = _l.next(); !_m.done; _m = _l.next()) {
                                        var math = _m.value;
                                ...
                                try {
                                    for (var _o = __values(jax.findMath(container)), _p = _o.next(); !_p.done; _p = _o.next()) {
                                        var math = _p.value;
